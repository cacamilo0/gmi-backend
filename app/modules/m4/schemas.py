...
class PartoCreate(SQLModel):
    gestante_id: str
    tipo_parto: str  # 'vaginal', 'cesarea'
    fecha_parto: date
...
class PartoUpdate(SQLModel):
    ...
    complicaciones: str | None = None
    uci_materna: bool | None = None
    muerte_materna: bool | None = None
    causa_muerte: str | None = None
    fecha_muerte: date | None = None


class PartoResponse(SQLModel):
    id: str
    gestante_id: str
    tipo_parto: str
    fecha_parto: date
...
class RecienNacidoCreate(SQLModel):
    parto_id: str
    vivo: bool
...
class RecienNacidoResponse(SQLModel):
    id: str
    parto_id: str
    vivo: bool
    peso_gramos: float | None = None
...
class PuerperioCreate(SQLModel):
    gestante_id: str
    dias_posparto: int
...
class PuerperioResponse(SQLModel):
    id: str
    gestante_id: str
    dias_posparto: int
    fecha_evaluacion: date
...
class AnticoncepcionCreate(SQLModel):
    gestante_id: str
    metodo_id: int | None = None
    fecha_aplicacion: date


class AnticoncepcionResponse(SQLModel):
    id: str
    gestante_id: str
    metodo_id: int | None = None
    metodo_nombre: str | None = None
    fecha_aplicacion: date
    created_at: datetime | None = None
